...
## <center> **دانشجو:** _محمدعلی زرین زاده_ </center>
...
این پروژه با استفاده از `jupyter notebook` پایتون پیاده سازی شده است. هر دو حالت `DTW` و `HMM` انجام شده است.
...
نکته مهم بعد از استخراج وِیژگی در تمامی سیستم های یادگیری ماشین و شناسایی الگو، هم مقیاس کردن تمامی ویژگی ها می باشد. برای این مورد ما از نرمال سازی رایج میانگین-واریانس استفاده کرده ایم. 
...
طیف ضرایب MFCC و مشتق مرتبه اول و دوم آن را برای یکی از نمونه ها پس از نرمال سازی مشاهده میکنید.
</div>
...
در ادامه ویژگی های دیگر داده هایمان را  استخراج شده و آن ها را نرمال میکنیم.
...
حال همه ی فاصله هایی که در داده های خام محاسبه کردیم را دوباره برای داده های با ویژگی نرمال شده تکرار میکنیم.
...
- **نویز گوسی:** به صورت تصادفی و بر اساس توزیع نرمال مقادیر داده ها را تغییر میدهد. این افزونگی فارق از ماهیت داده عمل میکند.
